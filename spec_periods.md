...
| P04       | `04_middle_late_bronze_age.json`             |   前2000—前1200 | 帝国化、战车、成熟青铜体系、外交体系、成文法、宫殿经济          |
| P05       | `05_iron_age_axial_world.json`               |    前1200—前500 | 铁器扩散、货币萌芽、大型帝国、骑兵、字母文字、官僚强化          |
| P06       | `06_classical_world.json`                    |      前500—300 | 希腊化、罗马、秦汉、孔雀帝国等；道路、法律、税制、标准化、国家工程    |
| P07       | `07_late_antiquity.json`                     |       300—700 | 晚期帝国转型、宗教制度化、庄园经济、丝路重构、纸张扩散          |
| P08       | `08_early_medieval.json`                     |      700—1000 | 伊斯兰世界扩张、唐宋前期、欧洲封建化、印度洋贸易、数学与造纸传播     |
